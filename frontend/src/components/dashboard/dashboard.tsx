        ...
        switch (activeView) {
                ...
                return (
                    <div className="h-full">
                        <Card className="border-zinc-800 bg-zinc-900/50 flex flex-col h-full overflow-hidden">
                            <CardHeader className="py-2 px-4 border-zinc-800 h-10 min-h-0 flex-shrink-0"><CardTitle>{`${UI_TEXT.titles.liveChart} - TON/USD`}</CardTitle></CardHeader>
            ...
            case 'spreads':
                return (
                    <div className="h-full">
                        <Card className="border-zinc-800 bg-zinc-900/50 flex flex-col h-full overflow-hidden">
                            <CardHeader className="py-2 px-4 border-zinc-800 h-10 min-h-0 flex-shrink-0"><CardTitle>{UI_TEXT.titles.spreadsAnalysis}</CardTitle></CardHeader>
